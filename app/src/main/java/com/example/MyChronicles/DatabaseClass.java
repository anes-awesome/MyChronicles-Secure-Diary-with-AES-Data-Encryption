...
public class DatabaseClass extends SQLiteOpenHelper {
    ...
    Context context;
    private static final String DatabaseName = "MyDiary";
    ...
    public Cursor getAllData(String ti){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("SELECT * FROM "+TableName+" WHERE TRIM("+ColumnTitle+") ='"+ti.trim()+"'", null);
        return res;
    }
